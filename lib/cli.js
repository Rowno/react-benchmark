          ...
          rules: [
            {
              ...
              exclude: path =>
                ...
                !path.includes('/react-benchmark/'), // Don't exclude ourselves 😆
              loader: 'babel-loader'
            }
          ]
        }
...
async function main() {
  ...
  await Promise.all([
    sander
      .copyFile(__dirname, 'client/index.html')
      .to(outputPath, 'index.html'),
    compile(userBenchmarkPath, cli.flags.debug)
  ])
